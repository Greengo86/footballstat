...
<div class="row text-center title">
    <h2 class="light muted margin-champ"><?php echo $champ?> <?php echo Html::img('@web/img/champ/' . $champ . '.png'); ?></h2>
</div>
<div class="owl-carousel owl-theme">
    ...
    <div class="col-md-6">
        ...
        <p class="description"><?php echo $team_offside?> <?php echo Html::img($team_embl_offside)?><br><?php echo $team_max_offside?> оффсайда за игру</p>
    </div>
    <div class="col-md-6">
        <div class="block-head">
