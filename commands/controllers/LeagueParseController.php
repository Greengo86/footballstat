...
class LeagueParseController extends ParseController
{
    ...
    public function actionSpain()
    {
        ...
        $url = 'http://soccer365-1.xyz/competitions/16/results/';
...
//                var_dump($value);
    ...
    public function actionGermany()
    {
         ...
         * зоны на 3 часа - для временной зоны Европа/Москва
         * */
        $url = 'http://soccer365-1.xyz/competitions/17/2017-2018/results/';
...
//            var_dump($value);
    ...
    public function actionItaly()
    {
         ...
         * зоны на 3 часа - для временной зоны Европа/Москва
         * */
        $url = 'http://soccer365-1.xyz/competitions/15/2017-2018/results/';
