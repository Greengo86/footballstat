...
<div class="container">
    ...
    <?php if ($match['delay'] == 1): ?>
        <div class="col-md-5 team-embl">
            <p class="text-right"><?php echo Html::img($match['teamHome']['team_embl']) ?><span
                        class="team"><?php echo $match['teamHome']['team_name'] ?></span>
            </p>
        </div>
        ...
        <div class="col-md-5">
            <p class="text-left"><span
                        class="team"><?php echo $match['teamAway']['team_name'] ?></span><?php echo Html::img($match['teamAway']['team_embl']) ?>
            </p>
        </div>
        <br class="">
