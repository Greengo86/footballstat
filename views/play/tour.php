...
<div class="container">
    <p class=""><h1 class="text-center text-info"><?= Html::encode($this->title) ?></h1></p>
    ...
    <div class="panel panel-danger">
        ...
        <div class="panel-body">
            <div class="menu-tour">
                <ul>
                    <?php $y = ceil($playCount/10); $i = 1; while ($i <= $y): ?> <!-- Округляем количество туров в большую сторону-->
    ...
    <?php foreach ($tour as $k => $game):?>
        ...
        <div class="text-center">
            <a class="show-match" href="<?php echo Url::to(['play/match', 'id' => $tour[$k]['id']]) ?>" data-id="<?= $tour[$k]['id']?>"><i class="glyphicon glyphicon-stats"></i>Статистика матча</a>
            <br>
        </div>
        <hr class="style1">
